 ...
 *
 * @param {planck.World} world      A planck world.
...
function ShellRobot(world, x, y, pathFinder) {
    ...
    body.setDynamic()
    body.setPosition(Vec2(this.x, this.y));
    ...
    //this.mass = shape.getRadius()*shape.getRadius()*Math.pi*fix.getDensity();
...
ShellRobot.prototype.stopMotion = function (dt) {
  ...
  this.body.applyForce(Vec2(fx, fy), this.body.getWorldCenter());
};
